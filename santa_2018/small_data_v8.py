...
centers.loc[0,'start_point']=coord[0]
centers.loc[0,'s1']=coord[1]
centers.loc[0,'s2']=coord[2]
...
'''
def two_parts(df,s,e):
    df_c = pd.concat([df,pd.DataFrame(columns=['up_down'])],sort=False)
